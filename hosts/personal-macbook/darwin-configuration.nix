...

{
  ...
  environment.shellAliases = {
    nix-reconcile = "sudo darwin-rebuild switch switch --flake github:NickMagic25/nix#personal-macbook --option tarball-ttl 0";
  };
        ...
        ''
          ...
          run_rebuild() {
            ...
            PATH=/nix/var/nix/profiles/default/bin:/opt/homebrew/bin:/usr/bin:/bin \
              darwin-rebuild switch switch --flake github:NickMagic25/nix#personal-macbook --option tarball-ttl 0 >> "$LOG" 2>&1
